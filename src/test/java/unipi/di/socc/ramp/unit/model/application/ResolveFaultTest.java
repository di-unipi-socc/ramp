...
public class ResolveFaultTest {
    ...
    {
        //exception cases
        assertThrows(NullPointerException.class, () -> this.testApp.resolveFault(null));
        ...
        assertThrows(
            ...
            () -> this.testApp.resolveFault(nonResolvableFault)
        );
        Fault unknownInstanceFault = new Fault("unknownID", this.awReq);
        assertThrows(
            InstanceUnknownException.class, 
            () -> this.testApp.resolveFault(unknownInstanceFault)
        );
        ...
        this.testApp.scaleOut("server", "serverID1");
        this.testApp.scaleOut("needy", "needyID");

        this.testApp.scaleOut("server", "serverID2");
        ...
        this.testApp.resolveFault(resolvableFault);
