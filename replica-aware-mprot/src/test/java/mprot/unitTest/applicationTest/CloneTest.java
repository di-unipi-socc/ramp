...
public class CloneTest {
    ...
    @Before
    public void setUp() {
        app = WebAppFactory.createApplication(PiVersion.GREEDYPI);
    }
    ...
    public void newwlyCreatedAppCloneTest() {
        ...
        for (BindingPair firstHalf : app.getBindingFunction().keySet()) {
            BindingPair secondHalf = app.getBindingFunction().get(firstHalf);
