package mprot.unitTest.parsingTest;
...
public class ParserTest {
            ...
            AlreadyUsedIDException 
    {
        ...
        Application factoryApp = WebAppFactory.createApplication(PiVersion.GREEDYPI);
    ...
    {
        String appPath = System.getProperty("user.dir").concat("\\data\\examples\\web-app\\app.json");
        String validPlanPath = System.getProperty("user.dir").concat("\\data\\examples\\web-app\\deploymentValidPlan.json");
        String weaklyValidPlanPath = System.getProperty("user.dir").concat("\\data\\examples\\web-app\\deploymentWeaklyValidPlan.json");
        ...
        assertTrue(analyzer.isValidSequence(app, planEElist));
        ...
        // if(analyzer.isValidPlan(app, weaklyValidPlanEElist, weaklyValidPlan.getConstraints()) == false){
        //     AnalysisReport failReport = analyzer.getFailReports().get(app.getName());
        //     assertTrue(failReport.getFailException().getMessage(), false);
        // }
