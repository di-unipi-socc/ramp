...
public class GetSatisfiedReqsTest {
            ...
            InstanceUnknownException 
    {
        ...
        BindingPair firstAsk = new BindingPair("nodeAsking", "reqA");
        BindingPair firstAns = new BindingPair("nodeServer", "capA");
        this.testApp.addStaticBinding(firstAsk, firstAns);

        BindingPair secondAsk = new BindingPair("nodeAsking", "reqB");
        BindingPair secondAns = new BindingPair("nodeServer", "capB");
        this.testApp.addStaticBinding(secondAsk, secondAns);

        BindingPair thirdAsk = new BindingPair("nodeAsking", "reqC");
        BindingPair thirdAns = new BindingPair("nodeServer", "capC");
